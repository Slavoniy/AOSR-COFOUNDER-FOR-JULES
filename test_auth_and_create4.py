...
with sync_playwright() as p:
    ...
    # Click sidebar item "Объекты", then click "Все объекты" which appears below it
    page.locator('text="Объекты"').first.click()
    page.wait_for_timeout(500)

    # Click "Все объекты" (the sub-menu item)
    page.locator('text="Все объекты"').first.click()
    page.wait_for_timeout(2000)

    page.screenshot(path="all_objects_view.png")
